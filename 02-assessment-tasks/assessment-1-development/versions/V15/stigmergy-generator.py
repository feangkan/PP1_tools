"""
Assessment 1 stigmergy generator  V15 / v1.8
...
def generate_diagram(params, status_cb):
    ...
    rs.ZoomExtents()
    status_cb(
        "V15: Update text restyles size and colour without regenerating.\n"
...
class StigmergyForm(eforms.Form):
    ...
    def __init__(self):
        ...
        self.Title = "A1 Stigmergy  V15  v1.8  (update text size / colour)"
        self.Resizable = True
    ...
    def _build_ui(self):
        ...
        self.Content = outer
        self.status_cb(
            "V15: Generate once, then change mm / colour chips and click Update text."
        )
