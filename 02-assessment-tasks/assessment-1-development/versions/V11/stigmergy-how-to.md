...
1. Script Editor → open `stigmergy-generator.py` (or `stigmergy-generator-V11.py`) → Run.  
2. Leave defaults (V11 — labels on node centres; dense line linkages). Click **Generate**.  
