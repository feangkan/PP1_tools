"""
Assessment 1 stigmergy generator  V14 / v1.7
...
def generate_diagram(params, status_cb):
    ...
    rs.ZoomExtents()
    status_cb(
        "V14: same size numbers as before; labels are mm not pt. Legend black; colour chips.\n"
...
class StigmergyForm(eforms.Form):
    ...
    def __init__(self):
        ...
        self.Title = "A1 Stigmergy  V14  v1.7  (sizes labelled mm)"
        self.Resizable = True
    ...
    def _build_ui(self):
        ...
        self.Content = outer
        self.status_cb(
            "V14: Title / Heading / Subtopic / Branch / Legend labelled mm. Same numbers. Colour chips."
        )
