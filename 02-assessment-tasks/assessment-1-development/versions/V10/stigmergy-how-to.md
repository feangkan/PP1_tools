...
1. Script Editor → open `stigmergy-generator.py` (or `stigmergy-generator-V10.py`) → Run.  
2. Leave defaults (V10 — dense stigmergy line linkages, no highway pipes). Click **Generate**.  
