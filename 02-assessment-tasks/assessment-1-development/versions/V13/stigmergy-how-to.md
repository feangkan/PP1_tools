...
| Tool | What it does |
|---|---|
| `stigmergy-generator.py` in Rhino | Geometry **and** Futura catalog text. **Sizes are millimetres.** Colour chip per text type; legend defaults to black. Annotation scale is forced to 1:1. |
...
1. Script Editor → open `stigmergy-generator.py` (or `stigmergy-generator-V13.py`) → Run.  
2. Leave defaults (V13 — millimetre sizes, black legend, colour chips). Click **Generate**.  
...
Font panel: Font **Futura** · sizes in **mm** · Title **2.5 mm** · Heading **2.5 mm** · Subtopic **1.5 mm** · Branch / ID **0.5 mm** · Legend **1.0 mm** · Text scale **1.0**. Legend colour defaults to **black**. Each type has a colour chip. The log after Generate lists the baked millimetre heights.
