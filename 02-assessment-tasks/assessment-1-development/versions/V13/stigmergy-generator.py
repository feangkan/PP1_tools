"""
Assessment 1 stigmergy generator  V13 / v1.6
...
def generate_diagram(params, status_cb):
    ...
    rs.ZoomExtents()
    status_cb(
        "V13: text sizes are millimetres (2.0 = 2.0 mm). Legend black; colour chips.\n"
...
class StigmergyForm(eforms.Form):
    ...
    def __init__(self):
        ...
        self.Title = "A1 Stigmergy  V13  v1.6  (sizes in mm)"
        self.Resizable = True
    ...
    def _build_ui(self):
        ...
        settings.AddRow(w.lbl(
            "Heights are millimetres in the model. Title 2.0 = 2.0 mm in Properties.",
            size=7.5,
        ))
        ...
        settings.AddRow(w.row2("Heading mm", self._heading_pt, self._heading_col))
        ...
        self.Content = outer
        self.status_cb(
            "V13: sizes are millimetres (Title 2.0 = 2.0 mm). Legend black; colour chips."
        )
