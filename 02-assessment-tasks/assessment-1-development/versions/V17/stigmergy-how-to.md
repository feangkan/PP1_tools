...
1. Script Editor → open `stigmergy-generator.py` (or `stigmergy-generator-V17.py`) → Run.  
...
4. **Where the words sit (on the circle, middle-center)**
   ...
   - Grey diamond = relation verb on the diamond (diamonds are small — 70% of older size)  
...
Font panel defaults (V17 / pic 2): Font **Futura** · Title **3.0 mm** · Heading / title **3.0 mm** · Subtopic **1.0 mm** · Branch / ID **0.1 mm** · Legend **1.5 mm** · Relation / loop **1.0 mm** · Text scale **1.0**. All colour chips **black**. White stroke behind text is on; text draws in front of disks. Untick “Hub / tip text uses group colour” stays off so black chips win.
