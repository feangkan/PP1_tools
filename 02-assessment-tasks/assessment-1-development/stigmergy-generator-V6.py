...
class StigmergyForm(eforms.Form):
    ...
    def __init__(self):
        ...
        self.Title = "A1 Stigmergy  V6  v0.9  (nerve sub-links)"
        self.Resizable = True
    ...
    def _build_ui(self):
        ...
        self._draw_bridges = w.check("Nerve sub-links between groups", True)
        ...
        self.Content = outer
        self.status_cb(
            "Scroll settings above. Generate + log stay pinned below.\n"
            "Fast + animated. Show pipes = full screen weight."
        )
